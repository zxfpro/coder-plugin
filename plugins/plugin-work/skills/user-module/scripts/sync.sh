...
# 更新配置
sed -i '' "s/user_module_/${MODULE_NAME}_/g" "$DEST_DIR/$MODULE_NAME/backend/server/models.py"
sed -i '' "s/user_module_/${MODULE_NAME}_/g" "$DEST_DIR/$MODULE_NAME/backend/server/config.py"
